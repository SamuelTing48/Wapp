<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBlog.aspx.cs" Inherits="Assignment.User.EditBlog" %>
...
<div class="content">
<h1 style="padding-left:10px">Edit Blog</h1>
<h2 style="padding-left:10px">Title</h2>
&nbsp&nbsp&nbsp<asp:TextBox ID="TextBox1" runat="server" CssClass="txtcontent" Width="30%"></asp:TextBox>
&nbsp;<br />
<br />
...
<br />
&nbsp&nbsp&nbsp<asp:TextBox ID="TextBox2" runat="server" CssClass="txtcontent"></asp:TextBox>
    <br />
<br />
<asp:Button ID="Button1" runat="server" Text="Save" CssClass="Createbutton" OnClick="Button1_Click" />
&nbsp;&nbsp;&nbsp;
    <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">Delete</asp:LinkButton>
<br />          
</div>
<div class="footer">
