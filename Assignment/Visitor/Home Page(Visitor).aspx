<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home Page(Visitor).aspx.cs" Inherits="Assignment.Visitor.Home_Page_Visitor_" %>
...
<asp:HyperLink ID="LearnLink" runat="server" NavigateUrl="~/Visitor/BrowseTutorial(Visitor).aspx">
        ...
        <div class="text">Learn</div>
                ...
                <div class="mySlides fade">
    <asp:HyperLink ID="BlogLink" runat="server" NavigateUrl="~/Visitor/BrowseBlog(Visitor).aspx">
        ...
        <div class="text">Blog</div>
                ...
                <div class="mySlides fade">
    <asp:HyperLink ID="ContactUsLink" runat="server" NavigateUrl="~/Visitor/ContactUs(Visitor).aspx">
        <img alt="our club" src="../back4.jpg" />
...
<div class="join-section">
    ...
    <asp:Button ID="JoinButton" runat="server" Text="Join Now" CssClass="join-button" PostBackUrl="~/Visitor/JoinUs(Visitor).aspx" />
</div>
