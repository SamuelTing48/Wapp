<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register(User).aspx.cs" Inherits="Assignment.Register" %>
...
<style>
    ...
    .footer {
        background-image: url('../plantingsecond.jpeg');
        background-size: cover;
        background-position:center;
        height: 300px;
        color: white;
...
Already have an account? 
    <a href = "../All/Login Page.aspx">Sign In</a>
</form>
</div>
