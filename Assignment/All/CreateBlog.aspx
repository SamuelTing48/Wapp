<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateBlog.aspx.cs" Inherits="Assignment.User.CreateBlog" %>
...
<div class="content">
<h1 style="padding-left:10px">Create Blog</h1>
<h2 style="padding-left:10px">Title</h2>
&nbsp&nbsp&nbsp<asp:TextBox ID="Title" runat="server" CssClass="txttitle" OnTextChanged="Title_TextChanged"></asp:TextBox><br />
<br />
...
<br />
&nbsp&nbsp&nbsp<asp:TextBox ID="content" runat="server" CssClass="txtcontent"></asp:TextBox><br />
<br />
<asp:Button ID="Button1" runat="server" Text="Create Blog" CssClass="Createbutton" OnClick="Button1_Click" />
<br />          
</div>
<div class="footer">
